...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{background/template_169_logos.pdf}}%
...
\begin{frame}
  ...
  Using data\_200k.csv try to classify signal vs background. 
  \begin{itemize}
  ...
  \item S and B myy distribution, for high discriminant scores (events likely to
    be S). 
  \end{itemize}
  {\bf Any feedback?} \href{https://cern.ch/l1feed}{\textcolor{EDBBlue}{https://cern.ch/l1feed}}
\end{frame}
...
{
\usebackgroundtemplate{\includegraphics[width=\paperwidth]{figures/l1/challenge/example_share}}%
\begin{frame}[plain]
\end{frame}
}
\backupend
